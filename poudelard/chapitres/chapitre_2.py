...
def rencontrer_amis(joueur):
    ...
    for i in range(3):
        ...
        if i == 0:
            ...
            options = ["Oui, j’adore apprendre de nouvelles choses !",
                       "Euh… non, je préfère les aventures aux bouquins."]
            message = "Que répondez-vous ?:\n"
        elif i == 2:
            options = ["Je lui serre la main poliment.", "Je l’ignore complètement.",
                       "Je lui réponds avec arrogance."]
            message = "Comment réagissez-vous ?:\n"

        list_narrateur = [
            "Vous montez à bord du Poudlard Express. Le train démarre lentement en direction du Nord... Un garçon roux entre dans votre compartiment, l’air amical.\n",
            "Une fille entre ensuite, portant déjà une pile de livres.\n",
            "Puis un garçon blond entre avec un air arrogant.\n"]
        list_phrase = ["- Salut ! Moi c’est Ron Weasley. Tu veux bien qu’on s’assoie ensemble ? ",
        ...
        if i == 0:
            ...
            if choix == 1:
                ...
                print('Hermione est ravie : — Ça nous fait un point en commun ! (intelligence+1)')
            else:
            ...
            if choix == 1:
                joueur['attributs']['ambition'] += 1
                print('Drago sourit : - Enchanté, je me nomme Drago Malefoy. (ambition+1)')
            elif choix == 2:
                joueur['attributs']['loyaute'] += 1
